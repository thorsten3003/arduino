...
int inPinI1 = A0;  // ESP8266 Analog Pin ADC0 = A0
...
double I_RATIO = (long double)CT_TURNS / CT_BURDEN_RESISTOR * 3.3 / 1024 * ICAL;
...
void setup() {
  ...
  WIFI_Connect();
              ...
              ArduinoOTA.setHostname("esp8266_SolarWechselstrom_messen");
            
              // No authentication by default
              ArduinoOTA.setPassword((const char *)"esp8266_SolarWechselstrom_messen");
