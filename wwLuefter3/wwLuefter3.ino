...
void setup(void) 
{
  ...
  analogWrite(luefter1, 255); // Lüfter aus. By changing values from 0 to 255 you can control motor speed
  ...
  digitalWrite(led1V, LOW); 
      delay(3000);
   analogWrite(luefter1, 0); // Lüfter aus. By changing values from 0 to 255 you can control motor speed
...
// LEDs und Lüftersteuerung
  ...
  if(tmpDiff > 4) {
      ...
      analogWrite(luefter1, 255); // By changing values from 0 to 255 you can control motor speed
      analogWrite(luefter2, 255);
      wartezeit = 20000;   
  }   
