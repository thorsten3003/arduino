...
// LEDs und Lüftersteuerung    1.5              
  ...
  if(tmpDiff > 2 and tmpDiff <=3.5) {
      ...
      if(!runterpusten) {
        analogWrite(luefter, 255); // Lüfter aus. By changing values from 0 to 255 you can control motor speed
        analogWrite(luefter2, 0);
        }
        else {
